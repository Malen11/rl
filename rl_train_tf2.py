...
from agents.PolicyBasedAgent import PolicyBasedAgent
...
def main():
    ...
    dir_name = 'no_limit_holdem_policy_based'
    test_name = 'test5'
    ...
    agent_test = DDQNAgent(
                     ...
                     mlp_layers=[10, 100],
                     discount_factor=0.9,
                     epsilon_decay_coef=math.pow(0.01, 1/(0.7*episode_num)),
                     batch_size=64,
                     activation_func='tanh', 
                     kernel_initializer='glorot_uniform')
    '''
    agent_test = PolicyBasedAgent(
                     action_num=env.action_num,
                     state_shape=env.state_shape,
                     mlp_layers=[8, 512],
